...
function agregarProducto() {
    ...
    if (count == 0) {
        ...
        // newtr = newtr + '<td><button type="button" onclick="myFunction('+d+')" name="contar[]" class="btn btn-danger btn-xs remove-item" ><i class="fa fa-times">Eliminar</i></button></td></tr>';
    ...
    // var sptext = text.split();
        ...
        // newtr = newtr + '<td><button type="button" onclick="myFunction('+d+'),operar('+multiplicar+')" name="contar[]" class="btn btn-danger btn-xs remove-item" ><i class="fa fa-times">Eliminar</i></button></td></tr>';
        newtr = newtr + '<input class="form-control" type="hidden" id="idprod'+d+'" readonly name="asd'+d+'" value="'+ idP +'"/>';
        newtr = newtr + '<input class="form-control" type="hidden" id="idprod'+d+'" readonly name="duplicado[]" value="'+ idP +'"/>';
